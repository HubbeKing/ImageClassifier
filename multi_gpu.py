...
# This has been added to the Keras source as of 2017-10-11, as keras.utils.multi_gpu_model()
# However, as of Keras release 2.0.8, it's not yet available
# Thus, we manually add it in
